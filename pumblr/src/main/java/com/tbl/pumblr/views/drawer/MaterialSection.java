...
public class MaterialSection<Fragment> extends it.neokree.materialnavigationdrawer.elements.MaterialSection implements View.OnTouchListener, View.OnClickListener {
    ...
    public MaterialSection(Context ctx, int iconType, boolean hasRippleSupport,  int target ) {
        super(ctx,iconType,hasRippleSupport,target);
