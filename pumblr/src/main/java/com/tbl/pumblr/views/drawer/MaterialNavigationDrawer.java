package com.tbl.pumblr.views.drawer;
...
public abstract class MaterialNavigationDrawer<Fragment> extends ActionBarActivity implements MaterialSectionListener,MaterialAccount.OnAccountDataLoaded {
    ...
    private boolean isCustomFoot;
    private boolean isCustomListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theme.resolveAttribute(R.attr.isCustomFoot,typedValue,false);
        isCustomFoot = typedValue.data != 0;
        theme.resolveAttribute(R.attr.isCustomListView,typedValue,false);
        isCustomListView = typedValue.data != 0;
        ...
        if(drawerHeaderType == DRAWERHEADER_ACCOUNTS)
            ...
            super.setContentView(R.layout.activity_material_customheader);
    ...
    public void setDrawerFooterCustom(View view) {
        if(!isCustomFoot)
            throw new RuntimeException("Your header is not setted to Custom, check in your styles.xml");
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        bottomSections.addView(view,params);
    }

    public void setDrawerListCustom(View view) {
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
